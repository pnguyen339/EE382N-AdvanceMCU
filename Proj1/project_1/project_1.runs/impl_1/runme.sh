...
HD_PWD='D:/Users/pnguy/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlockRam_wrapper.tcl -notrace
