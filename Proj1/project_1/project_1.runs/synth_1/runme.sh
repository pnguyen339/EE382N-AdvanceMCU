...
HD_PWD='D:/Users/pnguy/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRam_wrapper.tcl
