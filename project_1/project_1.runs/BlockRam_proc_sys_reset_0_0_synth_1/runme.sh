...
HD_PWD='/home/dratini/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/BlockRam_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRam_proc_sys_reset_0_0.tcl
