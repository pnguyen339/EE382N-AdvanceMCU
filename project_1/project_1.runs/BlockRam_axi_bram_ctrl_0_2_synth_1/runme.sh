...
HD_PWD='/home/dratini/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/BlockRam_axi_bram_ctrl_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_axi_bram_ctrl_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRam_axi_bram_ctrl_0_2.tcl
