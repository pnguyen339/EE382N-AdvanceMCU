...
HD_PWD='/home/dratini/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/BlockRam_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRam_processing_system7_0_0.tcl
