...
HD_PWD='/home/dratini/Documents/GitHub/EE382N-AdvanceMCU/project_1/project_1.runs/BlockRam_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlockRam_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlockRam_auto_pc_1.tcl
